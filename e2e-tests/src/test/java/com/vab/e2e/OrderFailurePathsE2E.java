...
class OrderFailurePathsE2E extends E2EBase {
    ...
    void reserve_item_not_found_fails() {
        ...
        String orderId = placeOrder("sub-e2e", "NOPE_NO_INVENTORY", "PHYSICAL_GOOD", 499, "PAY_NOW");
    ...
    void authorize_decline_over_threshold_fails() {
        ...
        String orderId = placeOrder("sub-e2e", "OTT_HOTSTAR_3M", "DIGITAL_SUBSCRIPTION", 1500, "PAY_NOW");
        awaitStatus(orderId, "FAILED");
    }
    ...
    void capture_hard_decline_at_pivot_fails() {
        ...
        String orderId = placeOrder("sub-e2e", "OTT_HOTSTAR_3M", "DIGITAL_SUBSCRIPTION", 777, "PAY_NOW");
        awaitStatus(orderId, "FAILED");
    }
}
